...
È possibile leggere una attenta analisi del codice al seguente [[https://www.google.com][link]]
...
:END:
Ringraziamo il professore [[mailto:a.botta@unina.it][Alessio Botta]] per lo splendido corso, che ci ha permesso di comprendere a pieno tecnologie di cui il mondo fa largo uso.
