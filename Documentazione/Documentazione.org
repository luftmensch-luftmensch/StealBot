...
+ Richiesta di mappatura della porta a uno specifico master
...
:END:
Durante le prove di testing \autocite{NoteDateTesting} , abbiamo recuperato le seguenti informazioni:
...
:END:
Di seguito vengono riportati alcuni estratti dei dati recuperati dall'applicativo [[https://www.wireshark.org/][wireshark]], ottenuti durante la prima prova:
* Ringraziamenti
:PROPERTIES:
