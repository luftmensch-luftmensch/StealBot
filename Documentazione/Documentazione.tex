...
\usetikzlibrary{calc,shadows,shapes,arrows,backgrounds,graphdrawing.trees, decorations.pathreplacing,positioning, arrows.meta, automata}
...
\begin{itemize}
\item Un \texttt{Bot Master} per la gestione dei dati ricevuti dal \texttt{bot slave} al quale impartisce comandi sfruttando una connessione tramite socket asincrona;
...
\item \texttt{.passwords} \(\rightarrow\) File contenente \texttt{eCambiata}
...
Ringraziamo il professore \href{https://www.docenti.unina.it/alessio.botta}{Alessio Botta} per lo splendido corso, che ci ha permesso di comprendere a pieno tecnologie di cui il mondo fa largo uso.
\end{document}
