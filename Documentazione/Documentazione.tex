...
\label{sec:orga2a20f3}
\subsubsection{Primo avvio}
\label{sec:orga9cdb6f}
...
\label{sec:orge01276c}
\subsubsection{Primo avvio}
\label{sec:org1b708c1}
Durante la fase di avvio il programma effettua le seguenti operazioni:
\begin{itemize}
