...
\usetikzlibrary{calc,shadows,shapes,arrows,backgrounds,graphdrawing.trees}
...
\item Richiesta di mappatura della porta a uno specifico master
\end{itemize}
